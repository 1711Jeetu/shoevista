  ...
  return (
    <main className='max-w-screen-xl mx-auto'>
      <div className="flex justify-center pt-7">
        <h2 className='text-4xl mb-6 font-semibold dark:text-slate-100 section-title pl-2 mt-2'>Kids's Section</h2>
      </div>
      ...
      <div className='flex flex-wrap justify-center mt-5 lg:flex-row'>
        ...
        {
        !isLoading && products.filter(product => product.gender==="KIDS").length === 0 && (<div className='text-2xl font-semibold dark:text-slate-100'>No Products Found</div>)
      }
        {
