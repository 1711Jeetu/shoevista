...
export const Footer = () => {
  return (
      ...
      <footer className="fixed bottom-0 left-0 z-20 w-full p-4 bg-white border-t border-grey-200 shadow p-6 dark:bg-slate-900 dark:text-white dark:border-slate-50">
